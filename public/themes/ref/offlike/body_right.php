...
<?php if ((int)$MW->getConfig->components->right_section->raf): ?>

    <div id="rightboxraf" style="position: relative; margin-left: 50px; margin-top: 20px">
        <div class="rafbutton" onclick="askrafname();" style="background: url(../images/button_raf.gif) no-repeat; height: 91px; width: 213px;">
        </div>
        <a id="raflink" href="<?php echo mw_url("server", "raf", "unknown")?>"></a>
    </div>
<?php endif; ?>
